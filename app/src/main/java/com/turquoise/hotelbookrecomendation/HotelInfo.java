...
//        Log.d("lll", "resume: "+hotelResult.getHotels().get(pos).getDraftBookings()+" "+hotel.getDraftBookings());
...
//        Notif.showToast(HotelInfo.this,sa);
...
//            Log.d("lll", "setBooking: saving "+(c+1));
...
//        Log.d("lll", "storeUpdates: "+hotelResult.getHotels().get(pos).getDraftBookings());
        spe.putString("data",save);
        spe.apply();
//        boolean a=spe.commit();
//        Log.d("lll", "storeUpdates: "+a);
